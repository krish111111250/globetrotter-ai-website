    ...
    return (
        <div className="min-h-screen bg-[#F1F5F9] font-sans">
            ...
            <main className="p-4 md:p-8 max-w-[1400px] mx-auto">
                ...
                {/* BANNER IMAGE */}
                <div className="relative w-full h-[300px] md:h-[450px] rounded-[30px] md:rounded-[50px] overflow-hidden shadow-2xl mb-8 md:mb-12 group">
                    <img
                        src="https://images.unsplash.com/photo-1476514525535-07fb3b4ae5f1?auto=format&fit=crop&w=1400&q=80"
                        alt="Travel Banner"
                        className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-[#102C57]/80 to-transparent flex flex-col justify-end p-6 md:p-12">
                        <p className="text-blue-300 text-[10px] md:text-xs font-black uppercase tracking-[0.4em] mb-2 md:mb-3">Welcome Back, Traveler</p>
                        <h1 className="text-white text-4xl md:text-6xl font-black uppercase italic tracking-tighter leading-none">
                ...
                <div className="flex justify-center mt-12 md:mt-20">
                    <button
                        ...
                        className="group relative bg-[#102C57] text-white px-8 md:px-12 py-4 md:py-6 rounded-2xl md:rounded-3xl font-black uppercase text-xs md:text-sm tracking-[0.2em] md:tracking-[0.3em] shadow-[0_20px_40px_-10px_rgba(16,44,87,0.4)] hover:bg-blue-900 transition-all hover:-translate-y-1 md:hover:-translate-y-2 active:scale-95"
                    >
                        <span className="flex items-center gap-2 md:gap-4 justify-center">
                            Plan A New Trip <span className="text-xl md:text-2xl group-hover:translate-x-2 transition-transform">→</span>
                        </span>
                    </button>
                </div>
