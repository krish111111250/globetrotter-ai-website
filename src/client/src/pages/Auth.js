...
const Auth = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F1F5F9] flex flex-col items-center justify-center p-4">
      ...
      <div className="w-full max-w-[480px] bg-white rounded-[30px] md:rounded-[50px] shadow-[0_40px_80px_-15px_rgba(16,44,87,0.25)] border border-white overflow-hidden relative">

        {/* HEADER SECTION */}
        <div className="bg-[#102C57] pt-10 md:pt-14 pb-20 md:pb-24 px-6 md:px-10 text-center relative">
          <div className="flex justify-center mb-2 md:mb-3">
            <span className="text-3xl md:text-4xl">✈️</span>
          </div>
          <h1 className="text-white text-2xl md:text-3xl font-black uppercase tracking-[0.2em] md:tracking-[0.25em] italic leading-none">Globetrotter</h1>
          <p className="text-blue-300 text-[8px] md:text-[10px] font-bold uppercase mt-2 md:mt-3 tracking-[0.2em] md:tracking-[0.3em] opacity-70">Travel Systems v2.0</p>
          ...
          <form onSubmit={handleAuth} className="space-y-4">
            {isLogin ? (
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <input name="email" type="email" placeholder="Email" className="sketch-input sm:col-span-2" onChange={handleInputChange} required />
